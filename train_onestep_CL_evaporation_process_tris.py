...
from transformer_onestep_CL_evaporation_process_bis import GPTClosedLoop
import tqdm
import argparse
import warnings
import wandb
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out-file', type=str, default="ckpt_onestep_evaporation_v13", metavar='S',
                        help='Saved model name')
    parser.add_argument('--in-file', type=str, default="ckpt_onestep_evaporation_v13", metavar='S',
